...
```
cd existing_repo
git remote add origin https://gitlab.com/owencuales/sf1-cosplay.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/owencuales/sf1-cosplay/-/settings/integrations)
